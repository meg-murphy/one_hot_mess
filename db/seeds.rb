...
category = Category.find_or_initialize_by(name: "Appetizers/Sides")
category.save
...
image = Image.find_or_initialize_by(url: "https://s-media-cache-ak0.pinimg.com/564x/bf/82/a8/bf82a8eea9c377b43e7b4466ed711c3e.jpg", recipe_id: recipe.id)
image.save
...
image = Image.find_or_initialize_by(url: "http://blog.williams-sonoma.com/wp-content/uploads/2014/02/WS_SD_LambCouscous_3864-652x784.jpg", recipe_id: recipe.id)
image.save
